...
# 定义抓取过程
class NBAFetcher(YCSpider.Downloader):
...
# 定义解析过程
class NBAParser(YCSpider.Parser):
...
if __name__ == "__main__":
    ...
    # 初始化爬虫, 并传入初始Url
    nba_spider = YCSpider.WebSpider(fetcher, parser, saver, url_filter=None)
    nba_spider.set_start_url(url_player_index)
